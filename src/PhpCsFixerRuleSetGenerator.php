...
final class PhpCsFixerRuleSetGenerator
{
    private const MAP = [
        ...
        '@PHP8x1Migration:risky' => 'php8x1-migration-risky.php',
        '@PHP8x2Migration' => 'php8x2-migration.php',
        '@PHP8x2Migration:risky' => 'php8x2-migration-risky.php',
        '@PHP8x3Migration' => 'php8x3-migration.php',
        '@PHP8x3Migration:risky' => 'php8x3-migration-risky.php',
        '@PHP8x4Migration' => 'php8x4-migration.php',
        '@PHP8x4Migration:risky' => 'php8x4-migration-risky.php',
        '@PHP8x5Migration' => 'php8x5-migration.php',
        '@PHP8x5Migration:risky' => 'php8x5-migration-risky.php',
        ...
        '@PHPUnit11x0Migration:risky' => 'phpunit11x0-migration-risky.php',
        '@PSR1' => 'psr1.php',
        '@PSR2' => 'psr2.php',
        '@PSR12' => 'psr12.php',

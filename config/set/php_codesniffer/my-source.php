...
return static function (Symplify\EasyCodingStandard\Config\ECSConfig $containerConfigurator): void {
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Strings\JoinStringsSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\CSS\BrowserSpecificStylesSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Objects\CreateWidgetTypeCallbackSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Objects\AssignThisSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Objects\DisallowNewWidgetSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP\EvalObjectFactorySniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP\AjaxNullComparisonSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP\GetRequestDataSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP\ReturnFunctionValueSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Commenting\FunctionCommentSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Debug\FirebugConsoleSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Debug\DebugCodeSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels\DisallowSelfActionsSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels\IncludeSystemSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels\IncludeOwnSystemSniff::class);
    $containerConfigurator->rule(\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels\UnusedSystemSniff::class);

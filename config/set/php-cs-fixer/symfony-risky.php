...
return static function (ECSConfig $ecsConfig): void {
    ...
    $ecsConfig->ruleWithConfiguration(\PhpCsFixer\Fixer\FunctionNotation\VoidReturnFixer::class, [
        'fix_lambda' => false,
    ]);
    $ecsConfig->ruleWithConfiguration(\PhpCsFixer\Fixer\Strict\DeclareStrictTypesFixer::class, [
        'strategy' => 'remove',
    ]);

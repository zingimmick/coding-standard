...
return static function (ECSConfig $ecsConfig): void {
    ...
    $ecsConfig->rule(\SlevomatCodingStandard\Sniffs\Classes\TraitUseOrderSniff::class);
    ...
    $ecsConfig->rule(\SlevomatCodingStandard\Sniffs\Classes\ReadonlyClassSniff::class);
    ...
    $ecsConfig->rule(\SlevomatCodingStandard\Sniffs\Exceptions\CatchExceptionsOrderSniff::class);
    ...
    $ecsConfig->rule(\SlevomatCodingStandard\Sniffs\Commenting\RequireOneDocCommentSniff::class);
    $ecsConfig->rule(\SlevomatCodingStandard\Sniffs\Commenting\ThrowsAnnotationsOrderSniff::class);
